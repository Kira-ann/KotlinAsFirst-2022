...
fun buildGrades(grades: Map<String, Int>): Map<Int, List<String>> {
    var gradeStudent = mutableMapOf<Int, MutableList<String>>()
    for ((student, grade) in grades) {
        if (gradeStudent[grade] == null) {
            gradeStudent[grade] = mutableListOf(student)
        }
        else gradeStudent[grade]!! += student
    }
    return gradeStudent
}
...
fun averageStockPrice(stockPrices: List<Pair<String, Double>>): Map<String, Double> {
    ...
    for ((value, element) in list) {
        list[value] = list[value]!! / cost[value]!!
    }
    return list
}
